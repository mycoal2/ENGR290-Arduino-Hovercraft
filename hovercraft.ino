...
// US SENSOR SPECIFIC
int frontTrigPin = 12; // yellow jumper --> pin 12: PB4
int frontEchoPin = 8;// blue jumper --> pin 8: PB0
...
// UltraSonicDistanceSensor leftSensor(trigPin, echoPin);
// UltraSonicDistanceSensor rightSensor(trigPin, echoPin);
